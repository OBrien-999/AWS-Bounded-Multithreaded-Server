...
public class Client {
    ...
    public static void main(String[] args) throws IOException {
	    ...
	    int currentConn = ThreadedPoolServer.counter.get() - 1;
	    int connLimit = ThreadedPoolServer.connections;

	      if(currentConn == connLimit){
		...
		for(int i = 0; i < 6; i++) {
			...
			System.out.println("Connection limit has been reached. Retrying in 10 seconds.");
